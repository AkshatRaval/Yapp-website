  ...
  return (
    <footer className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Card */}
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/2 backdrop-blur-xl p-8 md:p-16">
          {/* Decorative Glow */}
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-400 text-lg max-w-sm leading-relaxed">
                The future of social is voice. Join the conversation and start
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            ...
            <p className="flex items-center gap-1">
              Made with <span className="text-pink-500">♥</span> for the
              voice-first era.
            </p>
          </div>
        </div>
